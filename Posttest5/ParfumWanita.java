...
public class ParfumWanita extends Parfum {
    ...
    public final void unggulan(String unggulan) {
        System.out.println("Produk unggulan parfum Wanita adalah " + unggulan);
    }
...
public static ParfumWanita tambahParfumWanita() throws IOException {
    ...
    public String toString() {
        return "Parfum Wanita dengan nama " + nama + ", harga " + harga + ", aroma " + aroma + ", dan tingkat keharuman " + tingkatKeharuman + " jam.";
}
